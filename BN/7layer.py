...
def process(MC):
    ...
    if h <= 10 and 2 <= h:
        ...
        model1.add_module('FC6', torch.nn.Linear(neu, neu))
        model1.add_module('relu6', torch.nn.ReLU())
